...
public:
    binPeopleDetector()
    {
        ...
        faceDetector.load("../PeopleDetection/xmls/lbpcascade_frontalface_improved.xml");
    }
    ...
    {
        faceDetector.detectMultiScale(frame1,faceRects1);
        faceDetector.detectMultiScale(frame2,faceRects2);
    }
